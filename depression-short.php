<?php
/**
 * Anew Era Health — Depression, short edition.
 *
...
<!-- ─── Prevalence ─────────────────────────────────────────────────────
     One line rather than a panel of four figures. Kept as its own band so
     the page still gets a beat of colour between two light sections. -->
<section class="px-3 pb-3 sm:px-5 sm:pb-5 lg:px-8">
  <div class="relative isolate flex flex-col gap-3 overflow-hidden rounded-[24px] bg-[#0e537c] px-6 py-7 text-white sm:flex-row sm:items-center sm:justify-between sm:gap-10 sm:px-10 sm:py-8">
    ...
    <p class="relative m-0 max-w-[30ch] font-serif text-[21px] leading-[1.3] tracking-[-0.02em] sm:text-[26px]">
      Nearly <em class="not-italic text-[#cde3de]" data-count="15 million">15 million</em> American adults report a depressive episode each year.
    </p>
    <p class="relative m-0 shrink-0 text-[13px] leading-[1.6] text-white/70 sm:max-w-[24ch] sm:text-right">
      You are in far more company than it feels.
      <span class="mt-1 block text-[10px] font-bold uppercase tracking-[0.15em] text-[#8fc7e8]">NIMH</span>
    </p>
  </div>
</section>
...
<section id="symptoms" class="<?= $wrap ?> <?= $pad ?> <?= $anchor ?>">
  <div class="grid items-start gap-7 sm:gap-[34px] md:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)] md:gap-[45px] lg:gap-[70px]">
    ...
    <div>
      <p class="<?= $eyebrow ?>"><?= $dot ?> 02 / Signs and symptoms</p>
...
<section id="types" class="<?= $anchor ?> bg-white">
  <div class="<?= $wrap ?> <?= $pad ?>">
    <div class="grid items-start gap-7 sm:gap-[34px] md:grid-cols-2 md:gap-[45px] lg:gap-[80px]">
      ...
      <div>
        <p class="<?= $eyebrow ?>"><?= $dot ?> 03 / Kinds of depression</p>
...
<!-- ─── 04 · Treatment-resistant depression ──────────────────────────── -->
<section id="tms" class="<?= $anchor ?> px-3 py-3 sm:px-5 sm:py-5 lg:px-8">
  <div class="grid gap-3 md:gap-4 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
    ...
    <div class="relative isolate overflow-hidden rounded-[28px] bg-[#0e537c] px-6 py-8 text-white sm:px-7 sm:py-[38px] lg:px-[45px] lg:py-14">
      ...
      <div class="relative">
        <p class="m-0 mb-5 flex items-center gap-2.5 text-[11px] font-bold uppercase tracking-[0.17em] text-white/60 md:mb-[26px]"><?= $dot ?> 04 / Treatment-resistant depression</p>
...
<section id="faq" class="<?= $anchor ?> bg-mist">
  <div class="<?= $wrap ?> <?= $pad ?>">
    <div class="grid items-start gap-7 sm:gap-10 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] lg:gap-[72px]">
      ...
      <div>
        <?php foreach ($dep['faqs_short'] as $i => $faq): ?>
